package com.zbiti.myapplication.util;
...
import com.zbiti.myapplication.entity.AppEntity;
...
public class ShareUtil {
    ...
    public static void feedback(Context context) {
        Uri uri = Uri.parse("mailto:1032316751@qq.com");
        ...
        if (infos == null || infos.size() <= 0){
            Toast.makeText(context, context.getString(R.string.no_email_app_tip), Toast.LENGTH_LONG).show();
            return;
        }
